...
keywords: ["MCP", "Model Context Protocol", "AI assistant", "Claude", "Cursor", "Codex", "LLM"]
---
...
Set the `NFN_API_KEY` environment variable to your API key before starting Codex.
  </Tab>
