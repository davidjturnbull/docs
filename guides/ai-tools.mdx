...
- **ChatGPT / Claude / Perplexity** — open a conversation with the page loaded as context
- **Cursor / VS Code / Windsurf** — install the docs MCP server directly into your IDE
