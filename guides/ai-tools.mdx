...
Every page on this site is optimized for AI tools. Send content to your favorite AI assistant, connect the docs to your IDE, or point agents at machine-readable files.
...
## Build with machine-readable files
