...
description: "Structured, translated financial news from 50+ Nordic sources, delivered through a REST API and native MCP server."
keywords: ["Nordic", "financial news", "API", "MCP server", "translated news", "stock market", "REST API"]
---

Your agent gets clean, English-language articles with company metadata attached, ready to reason over.
...
<Columns cols={2}>
  ...
  <Card title="AI tools & resources" icon="sparkles" color="#01B2FF" href="/ai-tools" horizontal>
    Send pages to AI assistants, connect your IDE, or use machine-readable files.
  </Card>
</Columns>
