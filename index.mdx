...
description: "Structured, translated financial news from 50+ Nordic sources, delivered through a REST API and native MCP server. Built for agents, not browsers."
---
